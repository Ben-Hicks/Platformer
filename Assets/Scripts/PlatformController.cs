...
/***** TO FIX ******
 * when the platform is moving down, if you jump and hit the bottom
 * of the platform you can slide along the bottom without losing upward
 * player y velocity
 * *******************/
...
public class PlatformController : RaycastController {
	...
	Vector3 CalculatePlatformMovement(){
		...
		float easedPaercentBetweenWaypoints = Ease (percentBetweenWaypoints);

		Vector3 newPos = Vector3.Lerp (globalWaypoints [fromWaypointIndex], globalWaypoints [toWaypointIndex],
			easedPaercentBetweenWaypoints);
	...
	void CalculatePassengerMovement(Vector3 velocity){
		...
		//for horizontal/downward platforms
